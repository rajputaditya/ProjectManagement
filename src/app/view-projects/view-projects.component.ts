...
export class ViewProjectsComponent implements OnInit {
  ...
  userArray: Array<any> = [];
  url: string = "http://localhost:8086/restApiproject";
  ...
  urlForManagers:string="http://localhost:8086/restApimanagernames";
  ...
  sendProjectDetail(projectDetail: any) {
    ...
    this.url = 'http://localhost:8086/restApiprojectEmployees/' + projectDetail.projectName;
  ...
  searchEditProject() {
    this.searchdata = [];
    this.url = 'http://localhost:8086/restApisearch/' + (<HTMLInputElement>document.getElementById("searchProject")).value;
    console.log(this.url);
    this.http.get(this.url).subscribe(data => {
  ...
  searchDeleteProject() {
    this.searchdata = [];
    this.url = 'http://localhost:8086/restApisearch/' + (<HTMLInputElement>document.getElementById("searchDeleteProject")).value;
    console.log(this.url);
    this.http.get(this.url).subscribe(data => {
      JSON.parse(JSON.stringify(data)).forEach(element => {
        this.searchdata.push(element);
  ...
  editDetails(value) {
    ...
    this.url = 'http://localhost:8086/restApiproject/' + this.projectName;
    console.log(this.url);
